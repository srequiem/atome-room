...
const GoldenTicket = forwardRef(({ number }, ref) => (
  <svg ref={ref} className="ticket" viewBox="0 0 680 340" role="img" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="64" y="216" fontFamily="'IBM Plex Mono', monospace" fontSize="12" fill="#c9bfa6">Donne accès à un contenu exclusif à venir</text>
    ...
    <text x="452" y="268" textAnchor="end" fontFamily="'Instrument Serif', Georgia, serif" fontStyle="italic" fontSize="18" fill="#b8923f">Édition Nuit</text>
    ...
    <text x="549" y="150" textAnchor="middle" fontFamily="'IBM Plex Mono', monospace" fontSize="11" letterSpacing="3" fill="#c9bfa6">ADMIS</text>
    <text x="549" y="184" textAnchor="middle" fontFamily="'Instrument Serif', Georgia, serif" fontSize="32" fill="#f2ead8">UN</text>
...
const Finale = ({ onDismiss }) => {
  ...
  return (
    <div className="finale">
      <p className="finale__kicker">Tu as tout trouvé, bravo !</p>
      <p className="finale__text">
        Tu as gagné un golden ticket.<br />
        Il te permettra d'accéder à un contenu exclusif, donc garde-le bien !
      </p>
